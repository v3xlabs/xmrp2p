...
contract MoneroSwapTakeBuyOfferTest is Test {
    ...
    uint256 KEY_BASE = 10000000000000000000000;
    ...
    function test_RevertWhen_BuyOfferNotOpen() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferInvalidStateForTake.selector,
    ...
    function test_RevertWhen_NoValueAndNoFundingRequest() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferNoFundingRequestFound.selector
            )
        );
        moneroswap.takeBuyOffer(
            1,                 // offer id
    ...
    function test_RevertWhen_NoValueAndFundingRequestNotFunded() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorFundingRequestNotFunded.selector
            )
        );
        moneroswap.takeBuyOffer(
            1,                 // offer id
    ...
    function test_RevertWhen_NoValueAndFundingRequestAlreadyInUse() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorFundingRequestAlreadyInUse.selector
            )
        );
        moneroswap.takeBuyOffer{value: 0}(
            2,                 // offer id
    ...
    function test_RevertWhen_FundingRequestAvailable() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferAvailableFundingRequest.selector
            )
        );
        moneroswap.takeBuyOffer{value: 1 ether}(
            1,                 // offer id
    ...
    function test_RevertWhen_XMRAmountTooLow() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferXMRAmountTooLow.selector,
                UNITS_PER_XMR - 1,
                UNITS_PER_XMR
            )
        );
    ...
    function test_RevertWhen_PriceTooHigh() public {
        ...
        // Add a price oracle with a price of 0.6 ether (with 8 decimals, hence the division)
        DummyPriceOracle dummyPriceOracle = new DummyPriceOracle(8, 0.6 ether / 10_000_000_000, block.timestamp);
        vm.prank(msg.sender);
        moneroswap.setPriceOracle(address(dummyPriceOracle), 100);

        // Create a buy offer with a price of oracle price + 0.5. With the dummy oracle above this equals to 1.1 ether
        // so above the maximum. This will lead to a failure when taking the offer.
        ...
        moneroswap.createBuyOffer{value: 1 ether}(
            ...
            address(0),        // manager
            0,                 // fixed price
            RATIO_DENOMINATOR, // oracle ratio
            0.5 ether,         // oracle offset
            UNITS_PER_XMR,     // min XMR
            1 ether,           // max price
            KEY_BASE + 41,     // public spend key
            KEY_BASE + 42,     // public view key
            0                  // msg pub key
        );

        // Attempt to take the offer
        vm.deal(ADDR_2, 10 ether);
        vm.prank(ADDR_2);
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferPriceTooHigh.selector,
                1.1 ether, // Computed swap price
                1 ether  // maxprice
            )
        );
        moneroswap.takeBuyOffer{value: 4 ether}(
            ...
            UNITS_PER_XMR,     // maxxmr
            1 ether,           // minprice
            KEY_BASE + 43,     // publicspendkey
            KEY_BASE + 44,     // privateviewkey
            0                  // msgpubkey
        );
    }
    ...
    function test_RevertWhen_AmountTooLowToCoverFundingFee() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferAmountTooLowToCoverFundingFee.selector
            )
        );
    ...
    function test_RevertWhen_InvalidCounterparty() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MoneroSwap.ErrorBuyOfferInvalidCounterparty.selector
            )
        );
        moneroswap.takeBuyOffer{value: 1 ether}(
            1,                 // offer id
    ...
    function testTakeBuyOffer() public {
        ...
        assert(offer.state == MoneroSwap.OfferState.TAKEN);
    ...
    function testTakeBuyOfferWithFundingRequest() public {
        ...
        MoneroSwap.FundingRequest memory freq = moneroswap.getFundingRequest(ADDR_2);
