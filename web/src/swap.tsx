...
<TokenSelector token={fromToken} setToken={t => t === toToken() ? (setToToken(fromToken()), setFromToken(t)) : setFromToken(t)} />
        </div>
...
<TokenSelector token={toToken} setToken={t => t === fromToken() ? (setFromToken(toToken()), setToToken(t)) : setToToken(t)} />
        </div>
